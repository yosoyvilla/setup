---
name: security
description: Security review and advisory. Use for IAM policy review, secrets audit, compliance checks, or security scanning results analysis. Read-only -- does not modify code. Uses haiku for cost efficiency.
