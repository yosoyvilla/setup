---
name: infra
description: Infrastructure as Code and cloud architecture. Use directly for single-domain infra tasks like Terraform changes, AWS/GCP resource provisioning, Cloudflare DNS, Netlify config, or cost analysis. Skip lead agent for focused infra work.
