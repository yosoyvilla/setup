...
| project-c | `AWS_PROFILE=project-c aws eks update-kubeconfig --name project-c-project-c-eks --region us-east-1` |
| project-d | `aws eks update-kubeconfig --name project-d-eks --region us-east-2` |
| project-b GKE staging | `gcloud container clusters get-credentials k8s-project-b-gcp-staging --zone us-central1-a --project project-b-gcp-staging` |
| project-b GKE prod | `gcloud container clusters get-credentials k8s-project-b-gcp-prod --zone us-central1-a --project project-b-gcp-prod` |
