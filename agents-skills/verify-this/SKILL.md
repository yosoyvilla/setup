---
license: MIT — cursor/plugins cursor-team-kit
name: verify-this
...
- CLI/TUI behavior: terminal transcript or script -q recording.
- UI behavior: playwright tools: screenshots, accessibility snapshots, or network assertions.
